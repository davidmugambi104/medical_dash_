...
//   static async fetchPrescriptions(patientId = null) {
//     try {
...
//   static async fetchLabResults(patientId = null) {
//     try {
//       const params = patientId ? { patient_id: patientId } : {};
...
//   static async fetchMedicalRecords(patientId = null) {
//     try {
//       const params = patientId ? { patient_id: patientId } : {};
...
//   static async fetchVitalSigns(patientId = null) {
//     try {
//       const params = patientId ? { patient_id: patientId } : {};
...
//   static async fetchMedicationInventory() {
//     try {
...
//   static async fetchPendingActions() {
//     try {
//       const response = await api.get('/pending_actions');
//       return response.data;
//     } catch (error) {
...
//   static async completePendingAction(id) {
//     try {
//       const response = await api.post(`/pending_actions/${id}/complete`);
//       return response.data;
//     } catch (error) {
...
//   static async fetchPatientAnalytics() {
//     try {
//       const response = await api.get('/analytics/patient_stats');
//       return response.data;
//     } catch (error) {
